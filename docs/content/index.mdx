...
- [Installation Guide](/byonk/guide/) - Set up Byonk on your server
- [Architecture](/byonk/concepts/architecture) - Understand how Byonk works
- [Create Your First Screen](/byonk/tutorial/first-screen) - Build a custom display
- [API Reference](/byonk/api/http-api) - HTTP and Lua API documentation
