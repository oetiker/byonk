...
1. **[Your First Screen](/en/tutorial/first-screen)** - Create a simple "Hello World" screen
2. **[Lua Scripting](/en/tutorial/lua-scripting)** - Fetch data from APIs and process it
3. **[SVG Templates](/en/tutorial/svg-templates)** - Design beautiful layouts
4. **[Advanced Topics](/en/tutorial/advanced)** - HTML scraping, dynamic refresh, error handling

## Prerequisites

Before starting, make sure you have:

- Byonk [installed and running](/en/guide/installation)
...
Head to [Your First Screen](/en/tutorial/first-screen) to create your first custom display!
