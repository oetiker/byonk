...
- [Installation Guide](/en/guide/) - Set up Byonk on your server
- [Architecture](/en/concepts/architecture) - Understand how Byonk works
- [Create Your First Screen](/en/tutorial/first-screen) - Build a custom display
- [API Reference](/en/api/http-api) - HTTP and Lua API documentation
